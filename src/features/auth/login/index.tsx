                    ...
                    <div className="relative">
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <input
                            {...field}
                            className={`w-full pl-10 py-3 border rounded-lg ${errors.username ? "border-red-500" : "border-gray-300"}`}
                ...
                {CONTACTS.map((item) => {
                  ...
                  return (
                    <a
                      ...
                      className={` flex items-center justify-center gap-2 px-4 py-2 rounded-lg border border-blue-200 text-blue-700 text-sm font-medium ${item.bg} ${item.hover} transition-all duration-200 hover:shadow-md `}
                    >
