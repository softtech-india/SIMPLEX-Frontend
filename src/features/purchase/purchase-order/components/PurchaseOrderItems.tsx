      ...
      <div className="flex flex-wrap gap-4 items-end">
        ...
        <div className="w-120">
          ...
          <input
            ...
            onClick={() => {
              if (!item?.pcategoryid) {
                toast.warning("Please select a brand first");
                return;
              }
        ...
        <div className="w-28">
          ...
          <Controller
            control={control}
            name={`itemdtl.${index}.qty1`}
            defaultValue={0}
            rules={{ required: "Quantity is required", min: { value: 0, message: "Quantity must be greater than 0" } }}
            render={({ field }) => (
              <input
                type="number"
                disabled={isReadOnly}
