...
export const ProductDataGrid = forwardRef<any, ProductDataGridProps>(
  ({ dataSource, onSelectionChanged, onExporting, height = 600 }, ref) => {
    ...
    const columns = useMemo(() => [
      { dataField: 'productcode', caption: 'Product Code', width: 180, headerFilter: true },
      { dataField: 'productname', caption: 'Product Name', width: 220, headerFilter: true },
      ...
      { dataField: 'subclassnm', caption: 'Group', width: 150, headerFilter: true },

      { dataField: 'ptypeDesc', caption: 'Product Type', width: 150, headerFilter: true },
      { dataField: 'goodsservicetypedesc', caption: 'Goods/Service', width: 150 },
      ...
      { dataField: 'batchrequiredesc', caption: 'Batch Required', width: 150 },
      { dataField: 'valuationdesc', caption: 'Valuation', width: 150 },
      ...
      { dataField: 'statusdesc', caption: 'Status', width: 120 },
