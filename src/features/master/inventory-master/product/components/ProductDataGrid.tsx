...
export const ProductDataGrid = forwardRef<any, ProductDataGridProps>(
  ({ dataSource, onSelectionChanged, onExporting, height = 600 }, ref) => {
    ...
    const columns = useMemo(() => [
      ...
      { dataField: 'productname', caption: 'Name', width: 300, headerFilter: true },
      // { dataField: 'aliasname', caption: 'Print Name', width: 200, headerFilter: true },
      { dataField: 'categorynm', caption: 'Category', width: 100, headerFilter: true },
      { dataField: 'classnm', caption: 'Class', width: 100, headerFilter: true },
      { dataField: 'subclassnm', caption: 'Sub Class', width: 80, headerFilter: true },
      { dataField: 'unit', caption: 'Unit', width: 50 },
      // { dataField: 'altunit', caption: 'Alt Unit', width: 100 },
      { dataField: 'hsnNo', caption: 'HSN', width: 100 },
      { dataField: 'gstName', caption: 'GST', width: 80 },
      ...
      { dataField: 'mrp', caption: 'MRP', width: 70, dataType: 'number' },
      { dataField: 'statusdesc', caption: 'Status', width: 70 },
