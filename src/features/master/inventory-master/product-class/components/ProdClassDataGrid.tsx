...
import { ProdClass } from '../types/prodClass.types';
import CustomDataGrid from '@/common/components/sharedComponents/CustomDataGrid';

interface ProdClassDataGridProps {
  dataSource: ProdClass[];
...
export const ProdClassDataGrid = forwardRef<any, ProdClassDataGridProps>(
...
ProdClassDataGrid.displayName = 'ProdClassDataGrid';