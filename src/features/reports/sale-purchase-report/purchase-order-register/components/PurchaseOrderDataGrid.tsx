    ...
    return (
      <div style={{ width: '100%', height: '100%', overflow: 'auto' }}>
        <CustomDataGrid
          ...
          height={height}
          // CHANGE THIS: Remove scrollingMode or change to "virtual" for better scroll behavior
          scrollingMode="virtual" // Changed from "standard" to "virtual"
          // ADD THIS: Ensure columnAutoWidth is false to enable horizontal scrolling
          columnAutoWidth={false}
          // ADD THIS: Ensure proper width handling
          width="100%"
        />
      </div>
    );
