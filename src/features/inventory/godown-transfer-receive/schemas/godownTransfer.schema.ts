...
export const GodownTransferSchema = z.object({
  ...
  frombranchid: z.coerce.number().optional(),
  frombranchnm: z.string().optional(),
  fromBranchName: z.string().optional(),
  fromgodownid: z.coerce.number().optional(),
  fromgodownnm: z.string().optional(),
  ...
  togodownid: z.coerce.number().optional(),
