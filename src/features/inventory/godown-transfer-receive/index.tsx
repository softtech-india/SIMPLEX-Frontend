...
import { useGodownTransferList, useUpdateGodownTransfer } from './hooks/useGodownTransfer';
import { GodownTransfer, OperationMode } from './types/godownTransferReceive.types';
...
export default function GodownTransferModule() {
  ...
  const [formMode, setFormMode] = useState<OperationMode>('View');
  ...
  const handleReceiveClick = useCallback(() => openForm('Edit'), [openForm]);
    ...
    <>
      <div className="GodownTransferList-module ">
        ...
        <div className="bg-white rounded-xl shadow-sm border mt-2">
          ...
          <TransactionToolbar
            title="Godown Transfer Receive"
            permissions={permissions}
            onRefresh={handleRefresh}

            isFlexButton={true}
            flexButtonCaption="Receive"
            onFlexButton={handleReceiveClick}
