...
const BarManager: React.FC<BarManagerProps> = ({
  ...
  return (
    <>
      ...
      {isMobile && (
        <>
          <div className="w-full mb-0 bg-blue-900 border rounded-lg shadow-sm p-1 md:mb-1">
      ...
      {!isMobile && (
        <>
          <div className="bg-blue-900 md:bg-white border md:border-gray-200 rounded-lg shadow-sm p-1 md:mb-1">
            <div className="flex flex-wrap items-center w-full gap-3">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <InlineSelectField label="Date Range">
                  <DatePeriodPicker
                    value={{
                      period: saleRegCriteria?.period ?? "today",
                      fromDate: saleRegCriteria?.fromDate ?? new Date(),
                      toDate: saleRegCriteria?.toDate ?? new Date(),
                    }}
                ...
                <div className="relative" ref={exportRef}>
                  ...
                  {openExport && (
                    <div className="absolute right-0 mt-2 w-44 rounded-lg shadow-md z-50 bg-white">
                      <MenuItem icon={Download} onClick={() => { }}>Export File</MenuItem>
                      <MenuItem icon={Printer} onClick={onPrint} >Print</MenuItem>
                      <MenuItem icon={Mail} onClick={() => { }}>Email</MenuItem>
                    </div>
                  )}
